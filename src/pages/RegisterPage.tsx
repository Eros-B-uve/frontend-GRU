        ...
        <div className="w-full max-w-[1180px] grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="hidden lg:flex flex-col justify-center">
            ...
            <h2 className="text-5xl xl:text-6xl font-black text-[#0f5138] leading-tight max-w-[620px]">
              Registra tu institución y comienza a monitorear residuos
            </h2>

            <p className="mt-6 text-lg text-[#4b6359] max-w-[560px] leading-relaxed">
              Crea una cuenta asociada al CCT de tu escuela para acceder al panel
              de monitoreo, análisis y reportes de residuos sólidos.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10 max-w-[600px]">
              <FeatureCard
                icon={<School className="w-6 h-6" />}
                title="Vinculación por CCT"
                text="Cada usuario se asocia a una escuela."
              />

              <FeatureCard
                icon={<Recycle className="w-6 h-6" />}
                title="Gestión de residuos"
                text="Control por áreas y contenedores."
              />

              <FeatureCard
                icon={<BarChart3 className="w-6 h-6" />}
                title="Análisis visual"
                text="Gráficas para interpretar datos."
              />

              <FeatureCard
                icon={<FileText className="w-6 h-6" />}
                title="Reportes PDF"
                text="Generación de reportes por periodo."
              />
            </div>
          </div>
            ...
            >
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <p className="text-sm text-gray-500 mt-3 max-w-[330px]">
                  Ingresa tu correo, contraseña y el CCT de la escuela registrada.
                </p>
              </div>
              ...
              <div className="space-y-5">
                <InputField
                  ...
                  value={email}
                  onChange={setEmail}
                  icon={<Mail className="w-5 h-5 text-[#46c6a0] mr-3" />}
                />
                ...
                <InputField
                  ...
                  icon={<LockKeyhole className="w-5 h-5 text-[#46c6a0] mr-3" />}
                />
              ...
              <button
                ...
                className="text-sm font-semibold text-[#46c6a0] hover:underline mt-3">
                ¿Tu escuela no está registrada? Registrar escuela
            </button>
